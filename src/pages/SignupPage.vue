    ...
    <el-card>
      ...
      >
        ...
        <el-form-item>
          <el-container class="form-item buttons">
            <el-button
              ...
              v-if="!isLoading"
            >
              <el-icon><EditPen /></el-icon>&nbsp;SIGNUP
            </el-button>
        ...
        <el-container class="form-item">
          <el-text>I have an account.&nbsp;</el-text>
    ...
    return {
      ...
      rules: {
        ...
        password: [
          ...
          {
            pattern: this.$store.getters.passwordRegex,
            message:
              "Password is invalid. Use 'letters+numbers+symbols' format",
            trigger: "blur",
          },
        ],
      },
    ...
    async submitForm() {
      ...
      await this.$refs.form.validate(async (valid) => {
        ...
        if (valid) {
          ...
          const status = this.$store.getters.signupStatus;
          if (status.isValid) {
